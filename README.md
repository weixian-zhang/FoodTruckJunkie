...
| Frontend - Python Cli | run from Python [main.py](https://github.com/weixian-zhang/FoodTruckJunkie/blob/main/src/FoodTruckJunkie.Cli/main.py) examples: <br /> python main.py -h <br /> python main.py foodtrucks search <br/>python main.py foodtrucks search 37.79083842 -- -122.4012796 10 20 <br /> python main.py health <br/><br /> Cli as executable [ftj.exe](https://github.com/weixian-zhang/FoodTruckJunkie/tree/main/src/FoodTruckJunkie.Cli/dist) for Windows packaged using [Pyinstaller](https://pyinstaller.org/en/stable/usage.html), cmd examples:<br /> ftj foodtrucks search <br /> ftj foodtrucks search 37.79083842 -- -122.4012796 10 20  <br/><br/> |
...
* [AppSec](#appsec)
   ...
   * [Azure Software Development AppSec Guidelines](#azure-software-development-appsec-guidelines)
...
### Azure Software Development AppSec Guidelines
